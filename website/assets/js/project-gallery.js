...
const projectGalleries = {
  "bulgarian-talk-norms": {
    ...
    images: [
      shot("Screenshot 2026-07-01 204004.png", "Начална страница", "Въведение в платформата и основните теми за езикови норми и дискусии.", "Уебсайт"),
      shot("Screenshot 2026-07-01 204022.png", "За платформата", "Представяне на аудиторията, учебните материали и ресурсите за самообучение."),
      shot("Screenshot 2026-07-01 204035.png", "Стратегии за дискусия", "Практически насоки за ясен език, аргументация, формални изрази и противоположни гледни точки.", "Теория"),
      shot("Screenshot 2026-07-01 204047.png", "Примери за книжовен език", "Интерактивен пример, който сравнява разговорна и книжовна формулировка.", "Теория"),
      shot("Screenshot 2026-07-01 204056.png", "Избор на трудност", "Начален екран за избор между лесно, средно и трудно ниво.", "Упражнения"),
      shot("Screenshot 2026-07-01 204106.png", "Начало на упражнение", "Въвеждане на име и стартиране на обобщителен тест по книжовни норми.", "Упражнения"),
      shot("Screenshot 2026-07-01 204119.png", "Интерактивен тест", "Въпроси с избор на отговор за упражняване на правопис и граматика.", "Упражнения"),
      shot("Screenshot 2026-07-01 204135.png", "Резултат и обяснения", "Финален резултат с пояснения към отговорите.", "Резултати"),
    ],
  },
  "chat-app": {
    title: "Chat App",
  ...
  "car-rental": {
    ...
    images: [
      shot("main-page.png", "Начална страница", "Основен изглед на портала за наемане на автомобили.", "Основно табло"),
      shot("car-gallery.png", "Автопарк", "Преглед на наличните автомобили.", "Каталог"),
      shot("sign-up.png", "Регистрация", "Потребителска регистрация.", "Автентикация"),
      shot("rate-us.png", "Оценка", "Обратна връзка от клиенти.", "Отзиви"),
      shot("contact-us.png", "Контакти", "Информация за връзка с нас.", "Информация"),
    ],
  },
  "fitness-center": {
  ...
  "medica-pulse": {
    ...
    images: [
      shot("home-page.png", "Начална страница", "Централно табло на болничната система.", "Основно табло"),
      shot("cardiology.png", "Отделение Кардиология", "Преглед на медицинските услуги и специалисти.", "Отделение"),
      shot("patient-profiles.png", "Пациентски профили", "Управление на медицинска информация.", "Профили"),
      shot("information-page-for-the-client.png", "Информация за пациента", "Полезна информация за клиентите.", "Информация"),
      shot("registration.png", "Регистрация", "Създаване на нов пациентски профил.", "Автентикация"),
      shot("contact-us.png", "Контакти", "Връзка с администрацията.", "Информация"),
    ],
  },
  "prizma-studio": {
    title: "Prisma Studio",
